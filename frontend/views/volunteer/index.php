...
$this->title = 'Senarai Maklumat Sukarelawan';
?>
    <!-- BEGIN PAGE HEAD -->
    <div class="page-head">
        <div class="container">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Maklumat Sukarelawan</span>
                            </div>
                            <div class="actions">
                                    ...
                                    [
                                        ...
                                        'template'=>'{lihat}   {kemaskini}   {buang}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['volunteer/view','id'=>$model->volunteer_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['volunteer/update','id'=>$model->volunteer_id];
                                                    return $url;
                                                }
                                                if ($action === 'buang') {
                                                    $url = ['volunteer/delete','id'=>$model->volunteer_id];
                                                    return $url;
                                                }
                                            }
                                        ],
