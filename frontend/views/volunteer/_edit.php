                                                    ...
                                                    <div class="row">
                                                        <div class="portlet-body form">
                                                            <div class="form-body">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group form-md-line-input">
                                                                        <?= Html::activeTextInput($model,'time',['class'=>'form-control']); ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="portlet-body form">
                                                            <div class="form-body">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group form-md-line-input">
                                                                        <?= Html::activeTextInput($model,'tel_hp',['class'=>'form-control']); ?>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group form-md-line-input">
                                                                        <?= Html::activeTextInput($model,'tel_rumah',['class'=>'form-control']); ?>
                                                                        ...
                                                                        <div class="md-radio-inline">
                                                                            <div class="md-radio">
                                                                                <?php if ($model->kerja_sukarelawan == "Ya") { ?>
                                                                                    <input type="radio" id="radio53" name="Volunteer[kerja_sukarelawan]" class="md-radiobtn" value="Ya" checked="checked">
                                                                           ...
                                                                           <div class="md-radio">
                                                                                <?php if ($model->kerja_sukarelawan == "Tidak") { ?>
                                                                                    <input type="radio" id="radio54" name="Volunteer[kerja_sukarelawan]" class="md-radiobtn" value="Tidak" checked="checked">
                                                                                    
                                                                                <?php } else { ?>
                                                                                    <input type="radio" id="radio54" name="Volunteer[kerja_sukarelawan]" class="md-radiobtn" value="Tidak">
                                                                                <?php } ?>
                                                                                <label for="radio54">
                                                                                <span></span>
                                                                                <span class="check"></span>
                                                                ...
                                                                <div class="form-group form-md-line-input">
                                                                    <div class="input-icon right">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="md-radio-inline">
                                                                                    <div class="md-radio">
                                                                                        <?php if ($model->memiliki_kenderaan == "Ya") { ?>
                                                                                            <input type="radio" id="radio55" name="Volunteer[memiliki_kenderaan]" class="md-radiobtn" value="Ya" checked="checked">
                                                                                        <?php } else { ?>
                                                                                   ...
                                                                                   <div class="md-radio">
                                                                                        <?php if ($model->memiliki_kenderaan == "Tidak") { ?>
                                                                                            <input type="radio" id="radio56" name="Volunteer[memiliki_kenderaan]" class="md-radiobtn" value="Tidak" checked="checked">
                                                                                        <?php } else { ?>
                                                                                            <input type="radio" id="radio56" name="Volunteer[memiliki_kenderaan]" class="md-radiobtn" value="Tidak">
                                                                                        <?php } ?>
                                                                                        <label for="radio56">
                                                                                        <span></span>
                                                                                        <span class="check"></span>
